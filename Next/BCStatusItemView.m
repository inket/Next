...
{
	[[NSColor colorWithDeviceCyan:0 magenta:0 yellow:0 black:0 alpha:0] set];
	...
	if(drawnImage) {
		centeredRect = NSMakeRect(0, 0, [drawnImage size].width, [drawnImage size].height-1);
		...
		[drawnImage drawInRect:centeredRect fromRect:NSZeroRect operation:NSCompositeSourceOver fraction:1];
	}
